...
def cfg():
    ...
    path = {
        'log_dir': './runs',
        'SABS':{'data_dir': "/home/htang6/workspace/data/abdomen/superpixel/sabs_CT_normalized"
            },
        'C0':{'data_dir': "feed your dataset path here"
            },
        'CHAOST2':{'data_dir': "./data/CHAOST2/chaos_MR_T2_normalized/"
            },
        'SABS_Superpix':{'data_dir': "/home/htang6/workspace/data/abdomen/superpixel/sabs_CT_normalized"},
